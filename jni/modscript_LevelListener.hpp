...
class LevelListener {
	public:
		...
		virtual void addParticle(std::string const&, float, float, float, float, float, float, int) {} ; //10
		virtual void addParticle(ParticleType::Id, float, float, float, float, float, float, int) {} ; //11
